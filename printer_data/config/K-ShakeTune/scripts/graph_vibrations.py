...
def vibrations_calibration(lognames, klipperdir="/usr/data/share/klipper", axisname=None, max_freq=1000., remove=0):
...
def main():
    ...
    opts.add_option("-k", "--klipper_dir", type="string", dest="klipperdir",
                    default="/usr/share/klipper", help="main klipper directory")
